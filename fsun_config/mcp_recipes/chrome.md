...
|-------------------------------------|-------------|--------------------------------------------------------------------|------------------|
| Windows + WSL                       | PASS: DONE      | `~/devel/dotfiles/util/run_chrome_mcp_wsl` + `run_chrome_mcp.ps1`  | `mcp_recipes/chrome/` |
| Mac + Parallels Ubuntu VM           | PASS: DONE      | `~/devel/dotfiles/util/run_chrome_mcp` + `dev_sync`                | — |
